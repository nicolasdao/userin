...
const getFIPuserProcessor = (loginSignupMode='login') => openIdMode => {
	 ...
	 * @param {String}		code_challenge_method			Valid values: 'S256', 'plain'
	 * @param {String}		nonce					
	 ...
	 */
	return ({ user, strategy, client_id, response_type, scopes, state, code_challenge, code_challenge_method, nonce, redirect_uri }, eventHandlerStore={}) => catchErrors(co(function *() {
